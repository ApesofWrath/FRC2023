...
void swerveModule::ConfigModule(const ConfigType& type) {
    switch(type) {
        case ConfigType::motorDrive :
            ...
            m_motorDrive.SetInverted(ctre::phoenix::motorcontrol::TalonFXInvertType::CounterClockwise);
            m_motorDrive.SetNeutralMode(ctre::phoenix::motorcontrol::NeutralMode::Brake);
        ...
        case ConfigType::motorTurn :
            ...
            m_motorTurn.SetInverted(ctre::phoenix::motorcontrol::TalonFXInvertType::Clockwise);
            m_motorTurn.SetNeutralMode(ctre::phoenix::motorcontrol::NeutralMode::Brake);
