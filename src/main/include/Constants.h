...
namespace drivetrainConstants {
    ...
    namespace offsets {
        constexpr double kFrontRight{-176.57};
        constexpr double kRearRight{-142.64};
        constexpr double kFrontLeft{-117.33};
        constexpr double kRearLeft{-37.61};
    }
    ...
    namespace calculations {
        ...
        constexpr auto kModuleMaxAngularVelocity{wpi::numbers::pi * 4_rad_per_s};  // radians per second
        constexpr auto kModuleMaxAngularAcceleration{wpi::numbers::pi * 8_rad_per_s / 1_s};  // radians per second^2
